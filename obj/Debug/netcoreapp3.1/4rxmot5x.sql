...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'IdProgram', N'Dane', N'IdKlient', N'IdTrener', N'IdUwagi', N'KlientIdKlient', N'Ocena', N'UwagaIdUwaga') AND [object_id] = OBJECT_ID(N'[Programs]'))
    SET IDENTITY_INSERT [Programs] ON;
INSERT INTO [Programs] ([IdProgram], [Dane], [IdKlient], [IdTrener], [IdUwagi], [KlientIdKlient], [Ocena], [UwagaIdUwaga])
